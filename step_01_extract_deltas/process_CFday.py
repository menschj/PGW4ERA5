...
if __name__ == '__main__':
    ...
    out_base_dir = '/net/o3/hymet_nobackup/heimc/data/pgw/deltas/CFday'
    ...
    out_file_name = '{}_{}_{}.nc'.format(var_name, experiment, 
                            times[experiment][time_ind])

    # TODO: delete because does not support periodicity?
    subdomain = None
    #subdomain = dict(
    #    lon = slice(350,360),
    #    lat = slice(-10,0),
    ...
    targ_plev = np.sort(np.loadtxt('target_p_MPI-ESM1-2-HR.dat'))
    ...
    var_out = interp_logp_4d(var, source_P, targ_P, extrapolate='nan',
